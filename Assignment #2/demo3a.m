%
%Presentation of non-recursive myNCuts function for images d2a and d2b
%
...
label3a = myNCuts(matr1 , 3);
label4a = myNCuts(matr1 , 4);

label2b = myNCuts(matr2 , 2);
label3b = myNCuts(matr2 , 3);
label4b = myNCuts(matr2 , 4);
